          ...
          <div className="text-center mb-28">
            ...
            >
              ...
              <span className="relative inline-block pt-2">
                <span className="bg-green-100 text-green-600 px-6 py-1 items-center rounded-full">
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
            ...
            <div className=" flex flex-wrap justify-center gap-4 mt-10">
              <motion.button
                ...
                className="bg-black text-white px-10 py-3 rounded-full cursor-pointer hover:opacity-90 transition shadow-md"
              >
                {" "}
                Start Interview
              </motion.button>
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="border border-gray-300 px-10 py-3 rounded-full cursor-pointer hover:bg-gray-100 transition"
              >
                View History
              </motion.button>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
            {[
              ...
              <motion.div
                ...
                className={`relative overflow-visible bg-white rounded-3xl border-2 border-green-100
              hover:border-green-500 pt-14 pb-8 px-8 w-80 max-w-[90%] shadow-md
