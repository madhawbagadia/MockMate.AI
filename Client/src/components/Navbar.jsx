        ...
        <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
            ...
            className='w-full max-w-6xl bg-white rounded-3xl shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
                <div className='flex items-center gap-3'>
                    ...
                    <h1 className='font-semibold hidden md:block text-lg'>MockMate.AI</h1>
                </div>
                ...
                <div className='flex items-center gap-6  relative'>
                    <div className='relative'>
                        <button onClick={()=>{
                            ...
                            setShowCreaditPopup(!showCreaditPopup); setShowUserPopup(false)}} className='flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full text-md hover:bg-gray-200 transition cursor-pointer'>
                            <BsCoin size={20}/>
                            {userData?.credits || 0}
                        </button>
                        {
                    ...
                    <div className='relative'>
                        <button onClick={() => {
                            ...
                            setShowUserPopup(!showUserPopup);setShowCreaditPopup(false)
